...
export const Pricing = () => {
  ...
  <div 
    key={index}  // Add a key here for the outer div
    className={twMerge('p-10 rounded-3xl shadow-[0_7px_14px_#EAEAEA] border-[#F1F1F1] max-w-xs w-full', 
    ...
    <div className='flex justify-between'>
      ...
      {popular === true && (
        <div className='inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20'>
          <motion.span className='bg-[linear-gradient(to_right,#DD7DD7,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DD7,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] 
