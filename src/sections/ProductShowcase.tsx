...
import parymidImage from '@/assets/pyramid.png'
...
export const ProductShowcase = () => {
  ...
  return (
    ...
    <motion.img src={parymidImage.src} alt='pyramid Image' height={262} width={262} 
    className='hidden lg:block absolute -right-36 -top-32'
    style={{
      translateY,
    }}
    />
    <motion.img src={tubeImage.src} alt='pyramid Image' height={248} width={248} 
